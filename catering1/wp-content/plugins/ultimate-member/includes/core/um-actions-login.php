...
function um_add_submit_button_to_login( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php if ( isset($args['secondary_btn']) && $args['secondary_btn'] != 0 ) { ?>
			...
			<div class=""><input type="submit" value="<?php esc_attr_e( $primary_btn_word, 'ultimate-member' ); ?>" class="um-button" id="um-submit-btn" /></div>
...
.registeror{text-align:center;padding-top: 5px;
padding-bottom: 5px;}
</style>

<div class="registeror">OR</div>

<div class="catererbtn"><a href="http://scopun.co.uk/projects/catering1/caterer-registration/" class="um-button um-alt">Caterer Register</a></div>
<div class="catererbtn"><a href="http://scopun.co.uk/projects/catering1/bakery-registration/" class="um-button um-alt">Bakery Register</a></div>
<div class="catererbtn"><a href="http://scopun.co.uk/projects/catering1/customer-register/" class="um-button um-alt">Customer Register</a></div>
