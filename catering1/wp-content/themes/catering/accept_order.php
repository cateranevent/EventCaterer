...
$wpdb->query( $wpdb->prepare( "UPDATE menu_cart SET payment_type='Accept' WHERE cater_id = $user_id and order_id = '$order_id'" ) );
...
$to = $email;
$subject = "cateranevent@gmail.com - Accept Order";
$message = "
