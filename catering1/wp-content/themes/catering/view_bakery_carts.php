...
<?php
$ctr = 0;
$filelabjobpr = $wpdb->get_results("SELECT t1.cart_id, t1.menu_id, t1.cart_datetime, t1.cart_status, t2.menu_name, t2.menu_price, t2.categ_name FROM bakery_menu_cart t1 INNER JOIN bakery_menu t2 ON t1.menu_id = t2.menu_id where t1.user_id = $user_id and t1.cart_status = 0");         
...
$menu_price = $filesabjpbpr->menu_price;
$ctr++;
?>
        ...
        <tr>
            <td><?php echo $ctr; ?> -- <?php echo $menu_name; ?> -- £<?php echo $menu_price; ?></td>
        </tr>
